...
Pod::Spec.new do |s|
  s.name             = 'minjection'
  s.version          = '0.1.0'
  s.summary          = 'A short description of minjection.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Nicholas Elliott/minjection'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Nicholas Elliott' => 'nelliott@skywardapps.com' }
  s.source           = { :git => 'https://github.com/Nicholas Elliott/minjection.git', :tag => s.version.to_s }
